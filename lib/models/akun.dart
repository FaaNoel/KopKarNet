...
class AccountModel {
  ...
  String get formattedBalance => '\Rp ${balance.toStringAsFixed(3)}';
...
class AccountSet {
  ...
  double get total =>
      _accounts.fold(0.0, (prev, account) => prev + account.balance);

  String get formattedTotal => '\Rp ${total.toStringAsFixed(3)}';

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
          other is AccountSet && runtimeType == other.runtimeType &&
