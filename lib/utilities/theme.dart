...
class AppTheme {
  ...
  static const PrimaryColor = const Color(0xff10316b);
  static const backgroundColor = const Color(0xff102c5e);
  static const inputColor = const Color(0xFFffffff);
  ...
  static const panelColor = const Color(0xFF102c5e);
